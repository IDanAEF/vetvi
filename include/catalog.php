<section class="home__catalog page__block pt100">
    ...
    <div class="container">
        ...
        <?php endif; ?>
        <div class="home__catalog-list text_fz30 text_fw800 text_white">
            <?php
                $catalog = [
                    ...
                    ['Дверные ручки', IMAGES_PATH.'catalog-image6'],
                    ['Декор', IMAGES_PATH.'catalog-image7'],
                    ['Мебель', IMAGES_PATH.'catalog-image8'],
                    ['Настольные лампы', IMAGES_PATH.'catalog-image9'],
                ];
                                ...
                                for ($i = 0; $i < $diff; $i++) {
                                    ...
                                    if (isset($catalog[$currInd]) && $catalog[$currInd]) {
                                        ...
                                        <a href="/catalog/section/" class="home__catalog-list-item item<?=($count+1)?> no-hover elem_animate top">
                                            <picture>
                                                <source srcset="<?=$catalog[$currInd][1]?>.webp" type="image/webp">
                                                <img src="<?=$catalog[$currInd][1]?>.jpg" alt="<?=$catalog[$currInd][0]?>" class="img_bg">
                                            </picture>
